...
// We bake the rules into the model's core identity and force it to be cold and logical
const aiModel = genAI.getGenerativeModel({ 
    model: "gemini-2.5-flash",
    systemInstruction: `You are a strict data-validation robot for a Science Bowl game. You do not show mercy. Evaluate the player's answer against the official answer.

    RULES:
    1. MULTIPLE CHOICE: If an OFFICIAL LETTER is provided, the player is correct ONLY if they match the exact letter, the exact text, or both.
    2. LISTS: If the OFFICIAL ANSWER contains multiple items separated by semicolons (;) or commas (,), it is a list. The player MUST provide ALL items. If they miss even one item, or include extra incorrect items, "is_correct" MUST be false. However, if the answer is given as just the numbers labeling the choices(if there are any), it is correct and "is_correct" is true.
    3. TYPOS: Ignore minor spelling mistakes.

    You MUST return a JSON object with this exact structure:
    {"reasoning": "Briefly count the items and explain why it passes or fails.", "is_correct": true/false}`,
    generationConfig: {
        temperature: 0.0, // 0 means zero creativity, pure strict logic
        responseMimeType: "application/json" // Forces the API to ONLY output valid JSON
    }
});
...
{cat: "LIFE SCIENCE", type: "Toss-up", q: "Which of the following is NOT true of ribososmes: W) they help translate mRNA into protein X) they are too small to be seen with a compound light microscope Y) they are about 20 nanometers in diameter Z) bacterial and eukaryotic ribosomes are identical in shape and size", a: "BACTERIAL AND EUKARYOTIC RIBOSOMES ARE IDENTICAL IN SHAPE AND SIZE", letter: "Z"},
{cat: "LIFE SCIENCE", type: "Bonus", q: "Which of the following enzymes most likely catalyses the removal of electrons: W) transferase X) nuclease Y) hydrolase Z) oxidase", a: "OXIDASE", letter: "Z"},
{cat: "PHYSICAL SCIENCE", type: "Toss-up", q: "Which of the following would be the most logical choice for neutralizing a small amount of basic sodium hydroxide that was spilled on a lab bench: W) citric acid X) mercury pillow Y) concentrated sulfuric acid Z) concentrated hydrochloric acid", a: "CITRIC ACID", letter: "W"},
{cat: "PHYSICAL SCIENCE", type: "Bonus", q: "When the following chemical equation is balanced, the coefficient of oxygen will be what value: CH4 + O2 -> CO2 + H2O", a: "2", letter: ""},
{cat: "EARTH SCIENCE", type: "Toss-up", q: "Which of the following is an example of a mountain range that was primarily formed by a process of fault-blocking: W) the Grand Tetons, Wyoming X) the Andes Mountains Y) the Himalayas Z) the Hawaiin Islands", a: "THE GRAND TETONS, WYOMING", letter: "W"},
{cat: "EARTH SCIENCE", type: "Bonus", q: "Match each of the following 3 layers of the Earth, oceanic crust, continental crust, and mantle, respectively, with the following 3 approximate depths: 1) 25 to 90 kilometers; 2) 5 to 10 kilometers; 3) 2900 kilometers", a: "OCEANIC CRUST = 2) 5 TO 10 KILOMETERS; CONTINENTAL CRUST = 1) 25 TO 90 KILOMETERS; MANTLE = 3) 2900 KILOMETERS", letter: ""},
{cat: "GENERAL SCIENCE", type: "Toss-up", q: "Which of the following is NOT true of cholesterol: W) cholesterol is transported in blood X) LDL’s, or low density lipoproteins, are typically considered the “bad” cholesterol Y) elevated cholesterol often begins in childhood Z) cholesterol is a common component of plant cell membranes", a: "CHOLESTEROL IS A COMMON COMPONENT OF PLANT CELL MEMBRANES", letter: "Z"},
{cat: "GENERAL SCIENCE", type: "Bonus", q: "Which of the following foods contains the MOST milligrams of cholesterol: W) 1 cup dry, roasted cashew nuts X) 1 whole egg Y) 1 cup whole milk Z) 1 cup olive oil", a: "1 WHOLE EGG", letter: "X"},
{cat: "LIFE SCIENCE", type: "Toss-up", q: "Which of the following is considered the dominant generation in flowering plants: W) hypocotyl X) sporophyte Y) gametophyte Z) anthophyte", a: "SPOROPHYTE", letter: "X"},
{cat: "LIFE SCIENCE", type: "Bonus", q: "Which of the following is the most distinguishing characteristic of all vertebrates adapted to life on land from amphibians: W) lack of metamorphosis X) presence of true kidneys Y) production of amniotic eggs Z) presence of a coelom", a: "PRODUCTION OF AMNIOTIC EGGS", letter: "Y"},
{cat: "PHYSICAL SCIENCE", type: "Toss-up", q: "For 2 planets separated by a given distance, if the mass of one planet doubles, by what factor will the gravitational attraction between the planets be multiplied?", a: "2", letter: ""},
{cat: "EARTH SCIENCE", type: "Toss-up", q: "What is the most common astronomical term for the geometrical configuration where an inferior planet is between the Earth and the Sun?", a: "INFERIOR CONJUNCTION", letter: ""},
{cat: "EARTH SCIENCE", type: "Bonus", q: "Giving your answer as crescent, quarter, half, or full, an inferior planet will be in what phase when at inferior conjunction with Earth?", a: "CRESCENT", letter: ""},
{cat: "GENERAL SCIENCE", type: "Toss-up", q: "Fusion of which of the following 5 isotopes will produce the LEAST amount of net energy gain: hydrogen-1; deuterium; tritium; helium; iron", a: "IRON", letter: ""},
{cat: "GENERAL SCIENCE", type: "Bonus", q: "It is 8:55 PM, December 9 in Boston, Massachusetts, which is located at 71º west longitude. What time and day is it in London, England at 0º longitude? Make sure to give the time in AM or PM.", a: "1:55 AM; DECEMBER 10th", letter: ""},
{cat: "LIFE SCIENCE", type: "Toss-up", q: "How many carbon dioxide molecules are released in each turn of the Citric Acid Cycle?", a: "2", letter: ""},
{cat: "LIFE SCIENCE", type: "Bonus", q: "By words or numbers, name all of the following 3 places where you would most likely find dense meristematic tissue in a tomato plant: 1) just behind the root cap; 2) in the stem pith; 3) just behind the terminal buds", a: "1 AND 3", letter: ""},
{cat: "PHYSICAL SCIENCE", type: "Toss-up", q: "If the half-life of a given isotope is 7 days, what fraction of the original isotope will be left after 14 days?", a: "1/4", letter: ""},
{cat: "PHYSICAL SCIENCE", type: "Bonus", q: "Using proper chemical formulas, finish balancing the following equation: Ba(OH)2 + 2HCl -> what?", a: "BaCl2 + 2H2O", letter: ""}
];
...
// --- THE AI JUDGE ---
async function checkAnswerAI(question, officialAnswer, officialLetter, playerAnswer) {
    ...
    try {
        ...
        console.log(`\n[AI JUDGE] Player: "${playerAnswer}" | Official: "${officialAnswer}"`);
        ...
        console.error("AI Judge failed to parse JSON, using backup text checker...", error);
...
function startBonus(team) {
    ...
    timers.reader = setInterval(() => {
        if (game.wordIndex < game.words.length) {
            ...
            game.state = 'bonus'; 
            broadcastState(); 
            startCountdown(20, () => finishQuestion(false, "Time's up on Bonus.", "TIME!"));
        }
    }, 200);
}
...
socket.on('submitAnswer', async (ans) => {
        ...
        // NEW: Instantly clear any old CORRECT/INCORRECT/TIME logos from the screen!
        ...
        if (isCorrect) {
            ...
            if (game.state === 'buzzing' && game.isInterrupt) {
                let oppTeam = getOpposingTeam(p.team);
                scores[oppTeam] += 4;
                finishQuestion(false, `${p.name} INCORRECT INTERRUPT! (4 pts to Team ${oppTeam})`, "INCORRECT INTERRUPT!");
            } else {
